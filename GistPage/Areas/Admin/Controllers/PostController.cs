...
namespace GistPage.Areas.Admin.Controllers
{
    ...
    public class PostController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (loggedInUserRole[0] == WebsitesRoles.WebsiteAdmin)
            {
        ...
        public async Task<IActionResult> Create(CreatePostVM vm)
        {
            ...
            _notification.Success("Post Created");
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            if (loggedInUserRole[0] == WebsitesRoles.WebsiteAdmin || loggedInUser?.Id == post?.ApplicationUserId)
            {
                _context.Posts!.Remove(post!);
                await _context.SaveChangesAsync();
                _notification.Success("Delete Successful");
